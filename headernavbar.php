    ...
    <div class="container-fluid header">
        <div class="row" id="header">
            <div class="introduction col-lg-8 col-md-8 col-sm-12">
                <p>Larsen, votre agenda culturel gratuit <?php if (isset($_SESSION['userlogin'])) { ?> Bienvenue  <?= $_SESSION['users_login'] ?><a href="moncompte.php" class="btn btn-outline-warning" id="loginpicto"><i class="far fa-user fa-2x"></i></a>
