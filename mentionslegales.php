...
<html lang="fr">
    ...
    <body>
        ...
        <div class="row">
            <h2 class="myevents mx-auto">Mentions légales</h2>
        </div>
        <div class="text-justify">
            ...
            <p>
                ...
                Une question, un devis, contactez-nous nous vous rappelons dans les meilleurs délais.
                Nom

                Téléphone
            </p>
            <p>
                J´accepte que mes données personnelles soient utilisées pour être recontacté par Natural-net à des fins commerciales *
                ...
                ​- Youday (https://www.youday.fr/) en tant que CRM (Gestion de relation client).
                ...
                Ouverture commerciale du site de peintre plaquiste A2SO Trentini
                Mise en ligne du site Potenciel
                Tout savoir pour préparer le RGPD pour l'appliquer avant le 29 mai 2018
                Mise en ligne du site Apprendre à Conduire
                Un site Internet pour la Maison de la Traduction en Nouvelle Aquitaine

                Développer votre activité
                En agissant sur les leviers webmarketing
            </p>
        </div>
