...
include_once ('createanevent.php');
        ...
        <div class="container-fluid header">
            <div class="row">
                <div class="introduction col-lg-6 col-md-6 col-sm-12">
                    <h1>Professionnel ou particulier, bienvenue</h1> 
                </div>
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                            <div class="card" id="concert">
                                ...
                                <div class="footer">
                                    ...
                                    <div>Réserver vos billets<a href="https://www.digitick.com/"><img src="images/digitick.jpg" width="50px" /></a></div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>  
